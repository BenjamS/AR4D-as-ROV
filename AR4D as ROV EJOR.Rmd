...
In the AR4D context, the grounds for swallowing the bitter pill of numerical methods are especially narrow. Firstly, it is not even clear what a realistic time evolution of AR4D project NPV looks like. The time and expense involved in AR4D ex-ante impact assessment make frequent, regular updates of project NPV impractical, which in turn means that direct empirical inspection of the stochastic character of project NPV over a series of small, regularly spaced time steps is not possible---i.e., not in the way that is possible for a price series. Corporate ROV practitioners who do not invoke replicating portfolios face the same problem. P&L go to the extraordinary length of painstakingly building a dataset from scratch by documenting the NPV time series of several past projects; and then specifying and estimating a stochastic model for current project NPV on this basis.    How, then, to justify one stochastic model as more realistic than another?
