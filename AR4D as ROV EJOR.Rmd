...
Analogously, investors who "buy a real option" commit to funding a real project for a certain time period, at the end of which they have the right, but not the obligation, to continue funding the subsequent stage of the project. The project's net present value (NPV) is analogous to the price of the underlying security in the financial context, while the cost of the subsequent stage is analogous to the exercise price. (The cost of the subsequent stage must be known up front for the analogy to hold.) The methodological details of estimating the value of a real option can vary considerably from one use case to another. But, generally speaking, project real option value (ROV) is often higher than project NPV, especially for high risk, high reward projects, such that a risky project that would normally be rejected due to low or negative NPV might pass muster on an ROV basis.
<!-- [Incidentally, this is an additional benefit of ROV---it explicitly takes account of risk.] -->

In the AR4D context, it stands to reason that such arrangements could, in principle, be mutually beneficial for both donors and researchers alike. From the donor's perspective, ROV makes funding conditional upon progress and thus facilitates quick extrication from underperforming projects. This fiscal agility, in turn, facilitates long term commitments to risky research propositions, which is music to the ears of the research community. It is worth noting, moreover, that donors already acquire option value in their research investments---even if they do not explicitly call it that---since they reserve and frequently exercise the right to discontinue funding at specific time intervals. (Typical funding arrangements nowadays last for no more than 1-5 years, at the end of which the contract is up for review and renewal/cancellation.) ROV thus merely formalizes an already existing practice, and more accurately quantifies the real value acquired by the donor in exchange for their investment. Default methods of project appraisal (cost-benefit analysis, for example), by contrast, neglect to price in the donor's option value, and thus effectively understate the real value acquired by the donor.

ROV has been applied and discussed in private sector research contexts [@pennings1997option; @cassimon2004valuation; @doctor2001managing; @newton2004real]. Pennings and Lint [-@pennings1997option], in this journal, evaluated the ROV of a project to develop a new consumer electronics product at a private tech firm. In the present article, we extend this treatment to the AR4D context. Whereas private sector research addresses a market opportunity, AR4D addresses a market failure  ...to be released as public goods in developing countries. The present value of future impacts is calculated in terms of benefits...which can be multi-dimensional. The non-market valuation of such "intangibles" is itself a major open problem which is not addressed here.
In research contexts, the exercise price corresponds to the launch and scaling up of a proof of concept developed during the main stage of the project.  The exercise price, in this case, was the cost of building manufacturing plants required to produce the prospective product at scale plus marketing costs
