...
Up until now, ROV methods have developed in the context of corporate projects. Extension of these methods to the AR4D context is complicated by the sharp differences between the corporate and AR4D contexts. In particular, corporate project NPV is near enough to market---i.e. correlated enough with firm price, and/or a linear combination of other relevant prices---that it may, in principle, be modeled as a linear function of prices [@brennan1985evaluating; @koller2010valuation; @amram1998real]. Even in the corporate context, this argument faces skepticism [@borison2005real], known as the "replicating portfolio" argument, is strained even in the corporate context. [ROV proponents base this on a sophisticated technical argument called "replicating portfolios". This is called the   Or so say the ROV proponents.] AR4D projects, on the other hand, typically occur far from market, or even in the midst of market failures, such that project NPV must be estimated using non-market valuation techniques. ...Also not clear how the BS eq can be derived without the no-arbitrage argument [also risk-neutral valuation].
...
[may this the place to mention the low uptake]
