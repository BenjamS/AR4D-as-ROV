...
Where $y(t)$ stands for LBr potato net benefit at time $t$ after release, $\hat{t} =$ `r tRef`, $y(\hat{t}) =$ `r dNVT0ref * 10^6`, and $\alpha = $`r alphaQrly`.
...
The only remaining information required to calculate ROV is the LBr potato launch and up/outscaling cost due at $t = T_0$ upon successful completion of stage 4. For this pedagocgical exercise, we set it to a hypothetical value of $\$$`r Kvec[1] * 10^-3` thousand.
