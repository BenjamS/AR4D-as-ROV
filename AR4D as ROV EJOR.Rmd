...
Steps one and two constitute the main work of this article. In due course, two elementary, but no less novel and important, adjustments are also introduced in order to accommodate other key features of the AR4D context not captured by existing ROV methods. Firstly, we introduce a minor adjustment allowing us to account for project abandonment value. Secondly, a similarly minor adjustment is made to capture the marginally diminishing relationship between project impact and the final outscaling investment.

By "abandonment value", we mean the value often generated by AR4D projects regardless of the success or failure of the main research objectives. A project might generate abandonment value in the form of upgraded research facilities or improved human capital through training, for example.
