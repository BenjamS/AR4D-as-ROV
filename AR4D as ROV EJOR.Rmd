...
Analogously, investors who "buy a real option" commit to funding a real project for a certain time period, at the end of which they have the right, but not the obligation, to continue funding the subsequent stage of the project. In this context, the net present value (NPV) of future benefit streams expected to result from the project is analogous to the price of the underlying security; while the cost of the subsequent stage is analogous to the exercise price. (The cost of the subsequent stage must be known up front for the analogy to hold.) The methodological details of estimating the value of a real option can vary considerably from one use case to another. Generally speaking, project real option value (ROV) is never lower, and often higher, than project NPV, especially for high risk, high reward projects. Projects that would be rejected because of low or negative NPV may be appealing on an ROV basis.
<!-- [Incidentally, this is an additional benefit of ROV---it explicitly takes account of risk.] -->

In the AR4D context (and perhaps other project contexts), it is worth noting that donors effectively reserve and exercise the right to discontinue funding of subsequent stages of research, as AR4D project funding is usually up for renewal/cancellation every 1-5 years. ROV is thus an accurate measure of the real value acquired by the donor when they fund a given project stage. The default method of project appraisal, based on a purely NPV basis, fails to price in the donor's option value, and thus understates the real value acquired in exchange for their investment. Extending ROV to the AR4D context is thus merely a matter of evaluating the real value acquired    bringing quantitattive valuation methods in line with the reality. aligning theory with already existing practice.
