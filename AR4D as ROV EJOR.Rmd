...
The methodological details of estimating the value of a real option can vary considerably from one applied context to another. But, generally speaking, project real option value (ROV) is often higher than project NPV, especially for projects with high risk, high reward projects, such that a risky project that would normally be rejected due to low or negative NPV might pass muster on an ROV basis.
