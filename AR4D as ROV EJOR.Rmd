...
While it is intriguing to consider the possibility of modeling the NPV of a certain subset of "green" or "climate smart" AR4D projects as a linear function of the carbon price and/or green bonds [@tolliver2019green; @bhutta2022green], most AR4D projects focus primarily on public health, nutrition, and smallholder socioeconomic outcomes, especially for marginalized populations. The respective values of such outcomes, almost by definition, have no market analogue. And, even if they did, such market movements would be largely irrelevant. AR4D donors do not wait to see what markets say about ending child undernourishment and raising smallholder incomes, but rather start from the premise that these are worthy pursuits. There is thus no price risk involved in AR4D investments, but only the research risk associated with the project itself---i.e. the risk that the proposed technology will not function as expected---and the non-research risk associated with unforeseen, adverse developments in the enabling environment. Methodologically, this means that AR4D project NPV must be estimated the "hard way", by ex-ante impact assessment. Such assessments typically require a considerable investment of time, effort, and expertise, making frequent updates of project NPV unfeasible. As a result, we are left without a project NPV time series by which to estimate project risk or otherwise empirically inspect the stochastic character of project NPV.

Even in the corporate context, the replicating portfolios argument faces considerable skepticism [@borison2005real]; and proponents of the argument acknowledge that its validity is limited to a narrow range of project types [@schwartz2013real]. R&D projects in general are not among the project types where replicating portfolios may be plausibly invoked. In corporate R&D, "complete markets" are sometimes invoked in order to preserve risk-neutral valuation, many invoke   omplete markets [@pennings1997option]. This requires "manual" assessment of project NPV and risk, but saves the theoretical premise and risk-neutral valuation which for some reason is desirable to them....complete markets...leads to problematic risk-neutral valuation for AR4D
