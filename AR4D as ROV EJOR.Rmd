...
In real options language, USAID bought an option on stage 2 LBr potato research when it awarded the original contract to Cornell; but this option expired out of the money at the end of stage 1. USAID then effectively bought a second option on stage 2 research when it transferred the contract to MSU. This has expired in the money, triggering investment in stage 2 research. The investment in stage 2 research is effectively an option on stage 3. 
...
No ex-ante impact assessments of LBr potato in Bangladesh and Indonesia have yet been published. For the pedagogical purposes of this exercise, we assume a net benefit projection such as that in Figure...
...
#===============================================================================
# Stage cost and time duration params
...
alpha <- 0.7; A <- 1.5
dNVT0 <- A * t^alpha
dNPVT0_discrete <- dNVT0 / (1 + rYrly_discrete)^(t + tauVec[1])
...
# plot(t, dNPVT0)
# plot(t, NPVTn)
X0 <- NPVTn[25] * 10^6 # Choose 25 year cutoff
# Plot dNV, dNPV, NPV
dfPlot <- data.frame(`Net benefits` = dNVT0,
                     `Discounted net benefits` = dNPVT0_discrete,
                     NPV = NPVT0)
#===============================================================================
