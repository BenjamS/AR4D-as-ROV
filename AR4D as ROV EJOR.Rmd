...
Up until now, ROV methods have developed in the context of corporate projects. Extension of these methods to the AR4D context is complicated by a number of methodological challenges stemming from the key difference between the two contexts: corporate projects occur in market or near market settings, whereas AR4D projects are born of market failures. The methodological importance of this difference, for present purposes, is that, in corporate contexts, ROV proponents may invoke a financial argument called "replicating portfolios"---whereby they claim that project NPV is well approximated by a linear combination of relevant prices [@brennan1985evaluating; @koller2010valuation; @amram1998real]--- whereas in the AR4D context they may not.

Insofar as the replicating portfolios argument is valid, it plays a critical role in facilitating the evaluation of project NPV and risk, and in validating the basic option pricing formula (i.e., the B-S equation). That is to say, since the replicating portfolios argument effectively specifies project NPV as a linear function of prices, then project NPV may be easily calculated at any time from publicly available price information. Moreover, since price information is automatically updated on a second-by-second basis, a project NPV time series is generated by which to estimate project risk (i.e. the standard deviation of the project NPV fractional change per time step), and to otherwise empirically inspect the stochastic character of the time evolution of project NPV. And, critically, the replicating portfolios argument effectively construes project NPV as a traded good in an efficient market, which is critically important in the fundamental derivation of the option pricing formula we wish to adapt to the AR4D context.
<!-- (the "no-arbitrage rule"). -->

(Even in the corporate context, the argument faces considerable skepticism [@borison2005real].)

In cases where project NPV cannot possibly be construed as a traded good, complete markets. But still allows for the ...leads to awkward "risk-neutral valuation"
...
[1: replicating portfolio; 2: no arbitrage; 3: lack of data; 4: consensus against gBm; 5: multi-stage]

  and are based on market-bound assumptions which do not apply in the AR4D context.

In particular, corporate project NPV is near enough to market---i.e. correlated enough with firm price, and/or a linear combination of other relevant prices---that it may, in theory, be modeled as a linear function of prices []---although this argument is not without its critics []. AR4D projects, on the other hand, are typically born of market failures, with the aim of generating new technology to be released as a public good. The project NPV     The net benefit of such projects is measured not in terms of cash flow, but socio-economic and ecological impacts (for e.g., changes in smallholder incomes, public health and nutrition, and environmental services).     such that project NPV cannot be modeled. must be estimated using non-market valuation techniques. ...Also not clear how the BS eq can be derived without the no-arbitrage argument [also risk-neutral valuation].

* The market bound assumptions are  The non-market context in which most AR4D projects unfold is particularly


The estimation of AR4D project NPV typically requires a major investment of time, effort, and expertise, such that subsequent updates of NPV are unfeasible. This means there is no NPV time series, analogous to a price series, by which to empirically inspect and characterize NPV stochasticity. Does project NPV evolve as a geometric Brownian motion, a compound Poisson process, or something else?

Moreover, there is a strong consensus against gBm at great methodological cost... corp people be dissin the gBm bitter pill -- this will have to be tackled first, leads naturally then to derivation of (1-stage) ROV formula by straightforward integration based only on assumption of lognormal changes.
