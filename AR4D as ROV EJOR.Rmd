...
The final major methodological difference between corporate ROV concerns the time evolution of project NPV. A good stochastic model is required because  The stochastic character of project NPV is critical for risk assessment and thus also for ROV.  As noted above, in the AR4D context, project NPV is evaluated via ex-ante impact assessment. The time, effort, and expertise typically involved in such efforts make frequent subsequent NPV updates  infeasible, meaning that we are left without a time series by which to empirically inspect the stochastic character of the time evolution of project NPV. Instead, the stochastic character of AR4D project NPV must be inferred via well-reasoned argument. As noted above, changes in project NPV occur as a result of research and non-research related events, and it is reasonable to assume that, generally speaking, the time evolution of project NPV is characterized by relatively few large shifts---occurring, e.g., at the critical test points in the project timeline and/or major events in the enabling environment such as elections---interspersed with relatively many small shifts in NPV due to the more or less constant non-research related fluctuations in the enabling environment. Based on this rationale, the lognormal distribution is a reasonable choice as model of the size distribution of changes in project NPV. also methodologically expedient. The stochastic process called gBm corresponds to this
