...
Agricultural research for development (AR4D) projects tend to be high reward, but also high risk, propositions with long time horizons. Donors are attracted by the high potential payoff of such projects, but face increasingly austere fiscal outlooks that restrict their ability to engage in such long term, risky commitments. Real options valuation, a method adapted from financial analysis, presents a mechanism providing fiscally constrained donors with the flexibility they require to justify long term commitments by which researchers can secure long term funding.
...
The methodological details of estimating the value of a real option can vary considerably from one use case to another. But, generally speaking, project real option value (ROV) is often higher than project NPV, especially for projects with high risk, high reward projects, such that a risky project that would normally be rejected due to low or negative NPV might pass muster on an ROV basis.
...
ROV has been applied and discussed in private sector research contexts [@mitchell1990alternative; @pennings1997option; @cassimon2004valuation; @doctor2001managing; @newton2004real]. In the present article, we extend this treatment to the AR4D context.
...
Real options valuation has been applied to numerous research and non-research private sector project contexts; and details vary  (For a taxonomy, see Trigeorgis [-@].)]  ... [], for example, evaluate the real option value of a project to develop a new consumer electronics product at a private sector tech firm. The exercise price, in this case, is the cost of establishing the plant capacity required to manufacture the new product at scale, plus advertising, distribution, and any other marketing costs. 
