...
The choice of stochastic model of project NPV is important not only for project risk assessment, but also because it largely determines the methodological complexity of the ROV model. In this choice there is a tradeoff between realism and methodological expedience. The geometric Brownian motion (gBm) model of NPV      As noted above, in the AR4D context,  As noted above,  also methodologically expedient. The stochastic process called gBm corresponds to this
