...
Up until now, ROV methods have developed in the context of corporate projects. The many sharp differences between the corporate and AR4D contexts complicate the mere extension or adaptation of these existing methods to the valuation of AR4D projects. In particular, corporate project NPV is near enough to market---i.e. correlated enough with firm price, and/or a linear combination of other relevant prices---that it may, in principle, be modeled as a function of prices [@brennan1985evaluating; @koller2010valuation; @amram1998real]. [ROV proponents base this on a sophisticated technical argument called "replicating portfolios". This is called the   Or so say the ROV proponents.] AR4D projects, on the other hand, typically occur far from market, or even in the midst of market failures, such that project NPV must be estimated using non-market valuation techniques. The time and effort required for such estimation   [Even in the corporate context, the replicating portfolios argument has been severely criticized [@borison2005real]. In the AR4D context it is completely broke.]
