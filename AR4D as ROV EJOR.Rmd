...
Analogously, investors who "buy a real option" commit to funding a real project for a certain time period, at the end of which they have the right, but not the obligation, to continue funding the subsequent stage of the project. The project's net present value (NPV) is analogous to the price of the underlying security, while the cost of the subsequent stage is analogous to the exercise price. (The cost of the subsequent stage must be known up front for the analogy to hold.) The methodological details of estimating the value of a real option can vary considerably from one use case to another. But, generally speaking, project real option value (ROV) is never lower, and often higher, than project NPV, especially for high risk, high reward projects. For decision makers, this means that promising but risky projects that would normally be rejected in a conventional cost-benefit analysis might pass muster on an ROV basis.
<!-- [Incidentally, this is an additional benefit of ROV---it explicitly takes account of risk.] -->

By building in an option for the investor to discontinue project funding after a certain amount of time if the project is underperforming, the ROV approach provides the investor with the fiscal flexibility necessary to make long term commitments to research. This is mutually beneficial for both investors and researchers. It is also an accurate description of existing practice in the AR4D donor community. That is to say, most AR4D funding arrangements are structured such that the donor reserves and exercises the right to discontinue funding of subsequent stages of research. A typical contract is signed for no more than 1-5 years, at the end of which the contract is up for review and renewal or cancellation.

Default methods of project appraisal, such as conventional cost benefit analysis, fail to price in this option value, and thus effectively understate the real value acquired by the donor in exchange for their investment. ROV, by definition, prices in the de facto option value routinely exercised by donors, and is thus an accurate measure of the real value acquired by the donor in exchange for their investment.

ROV has been applied to private sector research contexts [@pennings1997option; @cassimon2004valuation; @doctor2001managing; @newton2004real]. In the present article, we extend this treatment to the AR4D context. The AR4D context differs from private sector ROV use cases
