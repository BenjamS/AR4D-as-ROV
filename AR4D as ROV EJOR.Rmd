...
\begin{equation}
\begin{split}
f_n(f_{n - 1}, t; T_{n - 1}, K_{n - 1}, s, r)|_{t = 0} &= e^{-r T_{n - 1}} E[\max(f(T_{n - 1}) - K_{n - 1}, 0)]\bigr|_{t = 0} \\
