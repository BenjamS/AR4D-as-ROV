...
runtitle: "Multi-stage research projects as real options"
documentclass: frontiersSCNS  # or frontiersHLTH, or frontiersFPHY
author:
  - name: Benjamin Schiek
    affiliation: '1'  
    etal: Schiek # First author's last name. 
    email: b.schiek@cgiar.org # Indicates corresponding Author
    institution: Performance, Innovation, and Strategic Analysis (PISA) For Impact, Alliance of Bioversity International and CIAT
    street: Km 17 Recta Cali-Palmira
    city: Palmira
    zip: 763537
    country: Colombia
affiliation:
  - id: '1'
    department: Performance, Innovation, and Strategic Analysis (PISA) For Impact
...
\tiny
 \keyFont{ \section{Keywords:} Real option value, Agricultural research for development, Risk neutral valuation, Abandonment value, Far-from-market }
...
\begin{equation}
\Delta f_1 = \left( \frac{\partial f_1}{\partial x} r x + \frac{\partial f_1}{\partial t} + \frac{s^2 x^2}{2} \frac{\partial^2 f_1}{\partial x^2} \right) \Delta t + \frac{\partial f_1}{\partial x} x s \epsilon \sqrt{\Delta t}
\end{equation}
...
\begin{equation}
\left( f_2 - \frac{\partial f_2}{\partial f_1} f_1 \right) r = \frac{\partial f_2}{\partial t} + \frac{s^2 f_1^2}{2} \frac{\partial^2 f_2}{\partial f_1^2}
\end{equation}

With corresponding Ito's lemma

\begin{equation}
\Delta f_2 = \left( r f_1 \frac{\partial f_2}{\partial f_1} + \frac{\partial f_2}{\partial t} + \frac{s^2 f_1^2}{2} \frac{\partial^2 f_2}{\partial f_1^2} \right) \Delta t + \frac{\partial f_2}{\partial f_1} f_1 s \epsilon \sqrt{\Delta t}
\end{equation}
...
\begin{equation}
\left( f_i - \frac{\partial f_i}{\partial f_{i - 1}} f_{i - 1} \right) r = \frac{\partial f_i}{\partial t} + \frac{s^2 f_{i - 1}^2}{2} \frac{\partial^2 f_i}{\partial f_{i - 1}^2} \;\;;\;\;\; i \in (1, n)
\end{equation}
