...
runtitle: "AR4D projects as real options"
...
\begin{equation}
\left( f_n - \frac{\partial f_n}{\partial f_{n - 1}} f_{n - 1} \right) r = \frac{\partial f_n}{\partial t} + \frac{s^2 f_{n - 1}^2}{2} \frac{\partial^2 f_n}{\partial f_{n - 1}^2}
\end{equation}
...
df_table %>%
  ...
  # kableExtra::column_spec(column = 2:4, width = "1.25in"
  # ) %>%
  kableExtra::footnote(
