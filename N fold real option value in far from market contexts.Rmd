...
Below I apply the $n$-fold option value model derived above to valuate a real AR4D project that began in [2010] and is [now nearing completion?]. The aim of the project was to develop a transgenic potato variety with resistance to Late Blight disease, for release as a public good in [SE Asia]. The donor was USAID, and the research entity implementing the project was Michigan State University, in partnership with Cornell University. The costs and time horizons used in the calculation of project ROV below are real, as documented in Schiek et al. [-@]. 
...
For the purposes of the present exercise, we transport to the beginning. An ex-ante impact assessment of the new technology gives a maximum, minimum, and most likely NPV. From these, $m$, $x_0$, and $s$ are derived. Since x(t) lognormal...

<!-- [Say something about the outcome of the project, how did it turn out?] -->
