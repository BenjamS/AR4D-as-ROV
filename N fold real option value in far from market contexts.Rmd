...
<!-- Researchers, with good reason, generally resent being forced to place a single value on impacts that may be 15-30+ years off in the future [@Petsko2011; @Moriarty2008; @leeuwis2018reforming]. -->
...
These upper and lower percentage errors may be interpreted...converted to log returns ln(R + 1)...and then interpreted as the bounds on the $95\%$ confidence interval about the mean of the log return $\mu$
...
This is for purely pedagogical purposes, and should not be interpreted as a rigorous justification for impact assessment of LBr potato. The stage costs and time horizons used in the valuation are based on those of a real LBr potato project; but the project NPV and launch cost are hypothetical. Results can vary considerably depending on the chosen discount rate.
