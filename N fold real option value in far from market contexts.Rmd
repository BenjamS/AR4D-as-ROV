...
\begin{equation}
e^{(m - r) T} x(0) - e^{-rT} (K - B) < S \:\: \rightarrow \:\: \text{reject project}
\label{eq:npvIneqB}
\end{equation}
...
\begin{equation}
e^{- r T_n} E[x(T_n)] \bigr|_{t = 0} - \Sigma_{i = 1}^{n - 1} e^{-r T_i} (K_i - B_i) < K_n \:\: \rightarrow \:\: \text{reject project}
\label{eq:npvIneqBN}
\end{equation}
...
\begin{equation}
e^{(m - r) T_n} x(0) - \Sigma_{i = 1}^{n - 1} e^{-r T_i} (K_i - B_i) < K_n \:\: \rightarrow \:\: \text{reject project}
\label{eq:npvIneqBN2}
\end{equation}

This is a straightforward generalization of expression \ref{eq:npvIneqB} to $n$-stage projects.
