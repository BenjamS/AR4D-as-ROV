...
Kvec <- 2 * c(600000, 181000, 312000, 336000) # Last stage first
Kvec <- 9 * c(600000, 181000, 312000, 336000) # Last stage first
#===============================================================================
# Calculate project NPV(Tn) i.e. X0
yrHoriz <- 15; qtrHoriz <- yrHoriz * 4
t <- seq(0, qtrHoriz, length.out = qtrHoriz + 1)
alphaYrly_discrete <- 0.8
...
library(expint)
NPVT0 <- A * (-gammainc(1 + alphaQrly, r * t) / r^(1 + alphaQrly) + gammainc(1 + alphaQrly, 0) / r^(1 + alphaQrly))
...
# plot(t, NPVTn)
#-------------------------------------------------------------------------------
nbCutoffYr <- 10 # Net benefit cutoff year
...
gg <- gg + labs(x = "Years from release")
gg <- gg + theme_bw()
gg
...
gg <- ggplot(dfdNPVT0, aes(x = Quarter, y = val, fill = type))
gg <- gg + geom_bar(stat = "identity", position = "dodge")
gg <- gg + scale_x_continuous(breaks = seq(0, qtrHoriz, 4),
                              labels = seq(0, yrHoriz, 1))
gg <- gg + labs(x = "Years from release", y = "Discounted net benefits\n(million USD)")
gg <- gg + theme_bw()
